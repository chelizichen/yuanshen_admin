<template>
  ...
  <div style="display: flex;">
    ...
    <el-input type="primary" size="small" v-model="pagination.keyword" style="width: 100px;margin:0 10px">搜索</el-input>
    <el-button type="success" size="small" @click="init">搜索</el-button>
  </div>
  <!-- 表格 -->
  <div>
    <el-table :data="state.list" style="width: 100%">
      ...
      <el-pagination background :current-page="Number(pagination.page)+1" 
